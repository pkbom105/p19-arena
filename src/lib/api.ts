/**
 * basePath ของแอป (เช่น '/booking') — ตั้งค่าผ่าน NEXT_PUBLIC_BASE_PATH ตอน build
 * ใช้คู่กับ basePath ใน next.config.ts เพื่อ deploy ภายใต้ subpath เช่น https://p19avenue.com/booking
 *
...
/** URL แบบเต็ม เช่น absoluteUrl('/ticket/XXXX1234') → https://booking.p19avenue.com/ticket/XXXX1234 */
